...
import ChangeData from "../booking/ChangeData/ChangeData";
import TitleCheck from "../../TitleCheck/TitleCheck";
import avatarIcon from "../../../assets/avatar.svg";
import "./articleCheckPassengers.css";

const ArticleCheckPassengers: React.FC = () => {
  const passengersList = useSelector(
    (state: RootState) => state.passengers.passengersList
  );
              ...
              <li key={index} className="check-passengers__item">
                <div className="check-passengers__avatar">
                  <img
                    ...
                    src={avatarIcon} // Переименовано
                    alt={`Аватар пассажира ${name}`} // Информативный alt
                  />
